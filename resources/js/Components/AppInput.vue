...
<template>
  <input
    class="border border-solid outline-none bg-primary border-primary-light focus:border-primary-light focus:ring-primary-light inline-flex w-16 text-center items-center justify-center text-[#DADCE5]"
