...
import { useCombatDuration } from '@/Composables/useCombatDuration';
...
const { combatDuration } = useCombatDuration(
  props.content.type === 'station' ? station : rebel,
  form.spacecrafts
);
...
<!--                     <div class="flex relative group items-center gap-2">
                    ...
                    <div class="flex relative group items-center gap-2">
                      ...
                      <p v-if="actionType === QueueActionType.MINING" class="font-medium text-sm text-slate-400">{{ miningDuration }}</p>
                      <p v-else class="font-medium text-sm text-slate-400">{{ combatDuration }}</p>
