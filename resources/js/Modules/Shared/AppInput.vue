...
<template>
  <input
    class="border-none outline-none bg-transparent w-full text-center text-light disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none focus:ring-0 focus:border-cyan-400/80 focus:border-x-2 transition-colors"
